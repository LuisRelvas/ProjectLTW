...
<html lang="en-US">
  <head>
    <title>FEUP Instructions for dummies</title>    
    <meta charset="UTF-8">
  ...
  <body>
    <header>
      <h1><a href="index.php">FEUP Instructions for dummies</a></h1>
      <h2><a href="index.php">YES, you!</a></h2>
      <div id="signup">
    ...
    <nav id="menu">
      ...
      <ul>
        <li><a href="index.php">OPTION 1</a></li>
        <li><a href="index.php">OPTION 2</a></li>
        <li><a href="index.php">OPTION 3</a></li>
        <li><a href="index.php">OPTION 4</a></li>
        <li><a href="index.php">OPTION 5</a></li>
        <li><a href="index.php">OPTION 6</a></li>
      </ul>
    </nav>
    <aside id="related">
      <article>
    ...
    <section id="news">
      <article>
        <header>
          <h1><a href="article.php">Quisque a dapibus magna, non scelerisque</a></h1>
        </header>
